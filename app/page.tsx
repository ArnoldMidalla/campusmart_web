  ...
  return (
    <>
      <main className="pb-28 pt-8 md:ml-64">
        ...
        <section className="flex flex-col gap-5 bg-white pt-0 pb-2 px-4 sm:px-6 md:px-8">
          <SearchBar />
          <CategoryList />
        </section>
        ...
        <section className="flex flex-col gap-3 bg-white py-5">
          ...
          {/* Carousel layout */}
          <div className="flex gap-4 sm:gap-5 md:gap-6 overflow-x-scroll pb-2 no-scrollbar px-4 sm:px-6 md:px-8">
