      ...
      <main className="flex flex-col max-w-md w-full justify-start pt-8 pb-12 overflow-y-auto">
        ...
        <section className="flex flex-col px-6 w-full">
          <h1 className="text-[32px] font-bold text-center text-[#1c1c1c] mb-8">
            Start selling on Campus Mart in seconds.
          </h1>
          ...
          <div className="p-1 border border-neutral-200 rounded-full w-full mb-6 relative hover:shadow-sm transition-all focus-within:ring-2 focus-within:ring-[#13368B]/20">
            <Link
              href="/onboarding/sellers/sign-up/two"
              className="flex items-center justify-center w-full bg-[#13368B] text-white py-3.5 rounded-full font-medium text-[15px] hover:brightness-105 transition-all"
            >
