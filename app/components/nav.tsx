...
export default function Nav() {
  ...
  return (
    <main className="fixed bottom-0 left-0 w-full flex justify-center pb-6 z-70 font-dmSans text-sm md:fixed md:top-0 md:h-dvh md:max-h-screen md:overflow-y-auto md:w-64 md:border-r md:border-neutral-200 md:bg-white md:z-40 md:justify-start md:pb-0 no-scrollbar">
