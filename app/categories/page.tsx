  ...
  return (
    <>
      <main className="pb-28 pt-8 md:ml-64">
        {/* Search Input */}
        <div className="flex flex-col gap-4 px-4 sm:px-6 md:px-8 lg:px-12">
        ...
        {/* Sorting Options */}
        <div className="flex gap-2 overflow-x-auto pb-2 no-scrollbar px-4 sm:px-6 md:px-8 lg:px-12">
        ...
        {/* Results Info */}
        <div className="flex justify-between items-center px-4 sm:px-6 md:px-8 lg:px-12">
        ...
        {filteredProducts.length > 0 ? (
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 px-4 sm:px-6 md:px-8 lg:px-12">
